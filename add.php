      ...
      if(isset($_GET["m"])){
          switch($_GET["m"]){
              case '1':
                  ...
                  break;
                  case '2':
                  ?><h4 style="color: green"> Datos ingresados correctamente</h4>
                  <?php                   
                  break;
          }
      }
?>
      <h1 align="center">Crear nuevos usuarios </h1>
      <br>
   <div class="container">
      <div class="card">
        <div class="card-body">
          <form action="" name="add" method="post">
            ...
            <div class="col-sm-4 col-4">
              ...
              <div class="col-sm-4 col-4">
                <div class="form-group">
                  <label>Nombre</label>
                  <input type="tex" name="nom1" class="form-control">
                </div>
              </div>
              <div class="col-sm-4 col-4">
                <div class="form-group">
              ...
              <div class="col-sm-4 col-4">
                <div class="form-group">
                  <label>Estado</label>
                  <select id="est" name="est"  class="form-control" style='width: 350px;'>                                             
           ...
           <input type="hidden" name="grabar" value="si">
            ...
            <a href="usuario.php"  class="btn btn-primary float-left" title="Volver Atras">volver atras</a>
          </form>
        </div>
      </div>
    </div>
